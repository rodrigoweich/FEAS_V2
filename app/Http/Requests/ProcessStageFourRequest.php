...
class ProcessStageFourRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            "box" => "required",
            "route" => "required",
            "distance" => "required|numeric|min:1",      //meters
            "real_meters" => "required|numeric|min:1"   //real meters
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            "surname.required" => "O campo sobrenome não pode ser nulo.",
            "surname.min" => "O campo sobrenome não pode conter menos de :min caracteres",
            "surname.max" => "O campo sobrenome não pode conter mais de :max caracteres",
            ...
            "route.required" => "A rota da fibra não pode ser nula.",
            "box.required" => "Você deve escolher uma caixa de atendimento para que o processo continue.",
            "distance.required" => "O campo distância aproximada não pode ser nulo.",
            "distance.numeric" => "O campo distância aproximada deve conter um valor numérico.",
            "distance.min" => "O campo distância aproximada não pode conter um valor menor que :min",
            "real_meters.required" => "O campo distância real não pode ser nulo.",
            "real_meters.numeric" => "O campo distância real deve conter um valor numérico.",
            "real_meters.min" => "O campo distância real não pode conter um valor menor que :min",
        ];
    }
}
