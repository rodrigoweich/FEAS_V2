...
class ProcessStageOneRequest extends FormRequest
{
    /**
    ...
    public function messages()
    {
        return [
            ...
            "contract_number.min" => "O campo número de contrato não pode conter números menores que :min",
            ...
            "number.min" => "O campo número de endereço não pode conter números menores que :min",
