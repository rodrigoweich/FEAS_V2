                            ...
                            <form action="{{ route('default.boxes.search') }}" method="post">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <div class="input-group-append">
                                        ...
                                        <a class="btn panel-border" href="{{ route('default.process_stage_four.index') }}" role="button" data-toggle="tooltip" data-placement="top" title="{{ __('Clear and return') }}"><i class="fas fa-undo-alt"></i></a>
                                    </div>
                                </div>
                            </form>
                        </div>
                                        ...
                                        <div class="d-flex align-content-center">
                                            @can('update-process-stage-four')
                                                @if($data->responsible_id === Auth::user()->id)
                                                    <a id="edit-button" href="{{ route('default.process_stage_four.edit', $data->id) }}"><button type="button" class="button-without-style mr-1"><i class="fas text-dark fa-edit"></i></button></a>
                                                @endif
                                            @endcan
