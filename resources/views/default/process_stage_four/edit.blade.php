...
<div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
        <div class="list-group list-group-flush">
            ...
            <a onclick="showAlertSave()" class="list-group-item list-group-item-action bg-light">{{ __('Save new process') }}<span class="float-right"><i class="fas fa-map-marked"></i></span></a>
            <a href="{{ route('default.process_stage_one.index') }}" class="list-group-item list-group-item-action bg-light">{{ __('Edit Customer Point') }}<span class="float-right"><i class="far fa-edit"></i></span></a>
            <a href="{{ route('default.process_stage_one.index') }}" class="list-group-item list-group-item-action bg-light">{{ __('Edit Box Service') }}<span class="float-right"><i class="far fa-edit"></i></span></a>
