                            ...
                            <form action="{{ route('admin.states.search') }}" method="post">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <div class="input-group-append">
                                        ...
                                        <a class="btn panel-border" href="{{ route('default.customers.index') }}" role="button" data-toggle="tooltip" data-placement="top" title="{{ __('Clear and return') }}"><i class="fas fa-undo-alt"></i></a>
                                    </div>
                                </div>
                            </form>
                        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        ...
                                        @elseif ($data->m_icon === 1)
                                        <i class="fas text-detail fa-check"></i>
                                        @else
                                        <i class="fas text-danger fa-check"></i>
                                        @endif
                                    </td>
                                    <td class="align-middle">
                                        <div class="d-flex align-content-center">
                                            @can('update-customers')
                                                <a href="{{ route('default.customers.edit', $data->id) }}"><button type="button" class="button-without-style mr-1"><i class="fas text-dark fa-edit"></i></button></a>
                                            @endcan
                                            @can('delete-customers')
                                                <form action="{{ route('default.customers.destroy', $data->id) }}" method="POST">
                                                    @csrf
                                                    {{ method_field('DELETE') }}
