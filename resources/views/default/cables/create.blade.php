...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-md-12 mb-3">
            <div class="card shadow-sm">
                <div class="card-body">
                    <form action="{{ route('default.cables.store') }}" method="post">
                        @csrf
                        <div class="row mb-3">
                            <div class="col">
                                <div class="form-row">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="number" min="2" max="6" class="form-control" id="inputsize" name="size" value="4" autofocus>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                ...
                                <div id="dotted_repeat" class="not-display">
                                    <div class="form-row">
                                        <hr class="solid">
                                        <div class="form-group col-md-12">
                                            <label for="inputrepeat">Espaçamento</label>
                                            <input type="number" min="12" max="35" class="form-control" id="inputrepeat" name="repeat" value="20" autofocus>
                                        </div>
                                    </div>
                                </div>
                            </div>
