...
<div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
        <div class="list-group list-group-flush">
            ...
            <a href="{{ route('default.process_list.index') }}" class="list-group-item list-group-item-action bg-light text-danger">Voltar<span class="float-right"><i class="far fa-hand-point-left"></i></span></a>
        </div>
    </div>
    <!-- /#sidebar-wrapper -->
            ...
            <div class="modal-body">
                ...
                <form id="thisForm" action="{{ route('default.process_stage_four.update', $response) }}" method="post" enctype="multipart/form-data">
                    ...
                    <span class="float-right">
                        ...
                        <a class="btn btn-success" href="{{ route('default.process_list.index') }}" role="button">Voltar</a>
                    </span>
                </form>
            </div>
        </div>
