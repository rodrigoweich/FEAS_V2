    ...
    <div class="container">
        ...
        <li class="nav-item dropdown" style="list-style: none;">
            <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                ...
                <span class="float-left mr-2"><img id="prevImg"
                        src="{{ config('global.type_asset')('/storage/'.Auth::user()->avatar) }}" alt="Avatar"
                        class="avatar-image"></span>
                @else
                <span class="float-left mr-2"><img id="prevImg"
                        src="{{ config('global.type_asset')('img/users/avatar.png') }}" alt="Avatar"
                        class="avatar-image"></span>
                @endif
            </a>
