...
<head>
    ...
    <title>FEAS - Relatório de regras</title>
        ...
        <table width="100%">
            <thead>
                <tr style="background-color: #F1F1F1 !important">
                    <th><b>#</b></th>
                    <th><b>Nome</b></th>
                    <th><b>Nome Gerencia</b></th>
                </tr>
            </thead>
            <tbody>
                @foreach ($response as $rule)
                <tr>
                    <td style="border-bottom: 1px solid #ddd !important;">{{ $rule->id }}</td>
                    <td style="border-bottom: 1px solid #ddd !important;">{{ $rule->display_name }}</td>
                    <td style="border-bottom: 1px solid #ddd !important;">{{ $rule->police_name }}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
