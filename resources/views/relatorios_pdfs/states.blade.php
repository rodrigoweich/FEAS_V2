...
<head>
    ...
    <title>FEAS - Relatório de estados</title>
    ...
    <div class="container" style="text-align: left !important;">
        ...
        <table width="100%">
            ...
            <tbody>
                ...
                <tr>
                    <td style="border-bottom: 1px solid #ddd !important;">{{ $state->id }}</td>
                    <td style="border-bottom: 1px solid #ddd !important;">{{ $state->name }}</td>
                    <td style="border-bottom: 1px solid #ddd !important;">{{ $state->uf }}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
