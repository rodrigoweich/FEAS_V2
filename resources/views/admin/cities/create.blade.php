...
<div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
        <div class="list-group list-group-flush">
            ...
            <a onclick="showAlertSave()" class="list-group-item list-group-item-action bg-light">{{ __('Save new city') }}<span class="float-right"><i class="fas fa-map-marked"></i></span></a>
