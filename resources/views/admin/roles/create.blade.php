                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-4">
                            ...
                            <span class="align-middle">&nbsp;&nbsp;Criar uma nova função</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <form action="{{ route('admin.roles.store') }}" method="post">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="inputname" name="name" value="{{ old('name') }}" required autofocus>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-12">
                        ...
                        <span class="float-right">
                            ...
                            <button type="submit" class="btn btn-detail">Criar função</button>
                        </span>
                    </form>
